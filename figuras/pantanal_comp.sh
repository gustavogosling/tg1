...
gmt grdcut -R-60/-52/-25/-14 $grade1 -Gcut1.grd 
gmt psbasemap -R -Bxya2 -BWNse -JM8 -X2 -Yc -P -K --FONT_ANNOT_PRIMARY=10p > "$3".ps
gmt makecpt -T-1/1/0.1 -Cpolar > brasil_der_1x1.cpt
gmt grdview cut1.grd -R -J -O -K -Qi -Cbrasil_der_1x1.cpt >> "$3".ps
gmt pscoast -R -J -O -K -W0.5p -Di -N1 -A10000+l >> "$3".ps

gmt grdcut -R $grade2 -Gcut2.grd
gmt psbasemap -R -Bxya2 -BwNsE -JM8 -X9 -Yc -O -K -P --FONT_ANNOT_PRIMARY=10p >> "$3".ps
