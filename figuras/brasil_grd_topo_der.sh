...
# Topo
gmt psbasemap -R-76/-32/-36/8 -Bxya10 -BWNse -JM8 -X2 -Yc -K -P > name
gmt grdview -R -J -O -K brasil.grd -Qi -Cpal_t.cpt >> name
gmt pscoast -R -J -O -K -W0.5p -Dl -N1 -A10000+l >> name
cat brasil_1x1.xy | gmt psxy -R -J -O -K -W2p,red >> name
cat brasil_05x05.xy | gmt psxy -R -J -O -K -W1p,green >> name
...
# Der
gmt psbasemap -R -Bxya10 -BwNsE -JM8 -X9 -Yc -K -O -P >> name
gmt grdview -R -J -O -K grad.grd -Qi -Cpal_d.cpt >> name
gmt pscoast -R -J -O -K -W0.5p -Dl -N1 -A10000+l >> name
cat brasil_1x1.xy | gmt psxy -R -J -O -K -W2p,red >> name
cat brasil_05x05.xy | gmt psxy -R -J -O -K -W1p,green >> name
cat resolucao_1x1.xy | gmt psxy -R -J -O -K -W2p,red >> name
cat resolucao_05x05.xy | gmt psxy -R -J -O -K -W1p,green >> name
