...
gmt grdcut -R-42/-38/-8.2/-6.7 $grade1 -Gcut1.grd 
gmt psbasemap -R -Bya1 -Bxa2 -BWNse -JM8 -X2 -Yc -P -K --FONT_ANNOT_PRIMARY=10p > "$3".ps
...
gmt psbasemap -R -Bya1 -Bxa2 -BwNsE -JM8 -X9 -Yc -O -K -P --FONT_ANNOT_PRIMARY=10p >> "$3".ps
