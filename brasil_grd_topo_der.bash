...
# Topo
gmt psbasemap -R-76/-32/-36/8 -Bxya10 -BWNse -JM8 -X2 -Yc -K -P > plot.ps
gmt grdview -R -J -O -K brasil.grd -Qi -Cpal_t.cpt >> plot.ps
...
gmt psscale -Dx0.75/-0.75+w6.5/0.25+h -Ba5000f50:'Topografia (m)': -J -R -Cpal_t.cpt -O -K --FONT_ANNOT_PRIMARY=10p --FONT_LABEL=11p  >> plot.ps
...
# Der
gmt psbasemap -R -Bxya10 -BwNsE -JM8 -X9 -Yc -K -O -P >> plot.ps
gmt grdview -R -J -O -K grad.grd -Qi -Cpal_d.cpt >> plot.ps
gmt pscoast -R -J -O -K -W0.5p -Dl -N1 -A10000+l >> plot.ps
cat brasil_1x1.xy | gmt psxy -R -J -O -K -W2p,red >> plot.ps
cat brasil_05x05.xy | gmt psxy -R -J -O -K -W1p,green >> plot.ps
cat resolucao_1x1.xy | gmt psxy -R -J -O -K -W2p,red >> plot.ps
cat resolucao_05x05.xy | gmt psxy -R -J -O -K -W1p,green >> plot.ps
gmt psscale -Dx0.75/-0.75+w6.5/0.25+h -Ba50f5:'Soma quadrática das derivadas (m/km)': -J -R -Cpal_d.cpt -O -K --FONT_ANNOT_PRIMARY=10p --FONT_LABEL=11p  >> plot.ps
...
rm -f plot.ps brasil.grd pal.cpt gmt.history
