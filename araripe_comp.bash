...
gmt grdcut -R-42/-38/-8.2/-6.7 figrd_1x1.grd -Gcut1.grd 
gmt psbasemap -R -Bya1 -Bxa2 -BWNse -JM8 -X2 -Yc -P -K > plot.ps
...
gmt psbasemap -R -Bya1 -Bxa2 -BwNsE -JM8 -X9 -Yc -O -K -P >> plot.ps
